...
public class NVPAPICaller
{
    ...
    public string APIUsername = "ats3216-facilitator_api1.uw.edu";
    private string APIPassword = "JW4ZD8FBCRSTQQS6";
    private string APISignature = "Aop6tpxPxIPDq1DWKbY70REMIGVCAPkXzJU84rSguq37pCtpJnVC0xYH";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "Infanos Games Sample App";
        ...
        using (Infanos.Logic.ShoppingCartActions myCartOrders = new Infanos.Logic.ShoppingCartActions())
        {
            List<CartItem> myOrderList = myCartOrders.GetCartItems();

            for (int i = 0; i < myOrderList.Count; i++)
            {
                encoder["L_PAYMENTREQUEST_0_NAME" + i] = myOrderList[i].Game.GameName.ToString();
                encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].Game.GamePrice.ToString();
