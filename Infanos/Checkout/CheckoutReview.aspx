<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckoutReview.aspx.cs" Inherits="Infanos.Checkout.CheckoutReview" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="OrderItemList" runat="server" AutoGenerateColumns="False" GridLines="Both" CellPadding="10" Width="500" BorderColor="#efeeef" BorderWidth="33">              
        <Columns>
            ...
            <asp:BoundField DataField="Game.GameName" HeaderText=" Game Name" />        
            <asp:BoundField DataField="Game.GamePrice" HeaderText="Price (each)" DataFormatString="{0:c}"/>     
    ...
    <p></p>
    <hr />
    <asp:Button ID="CheckoutConfirm" runat="server" Text="Complete Order" ForeColor="Black" OnClick="CheckoutConfirm_Click" />
</asp:Content>